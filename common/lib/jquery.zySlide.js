...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        // 点击切换到上一张
        this.$ele.find('section:nth-child(news1)').on('click', function () {
            this.stop()
            this.prev()
            this.play()
        }.bind(this))
...
//--------------------------------------------------------------------------------------//
    ...
    //     var states = [
    //         { '&zIndex': news1, width: 120, height: 150, top: 71, left: 134, $opacity: 0.5 },
    //         { '&zIndex': 2, width: 130, height: 170, top: 61, left: 0, $opacity: 0.6 },
    //         { '&zIndex': 3, width: 170, height: 218, top: 37, left: 110, $opacity: 0.7 },
    //         { '&zIndex': 4, width: 224, height: 288, top: 0, left: 262, $opacity: news1 },
    //         { '&zIndex': 3, width: 170, height: 218, top: 37, left: 468, $opacity: 0.7 },
    //         { '&zIndex': 2, width: 130, height: 170, top: 61, left: 620, $opacity: 0.6 },
    //         { '&zIndex': news1, width: 120, height: 150, top: 71, left: 496, $opacity: 0.5 }
    //     ]
    //     var lis = $ele.find('li')
    //     var interval
    ...
    //     })
    //     // 点击切换到上一张
    //     $ele.find('section:nth-child(news1)').on('click', function () {
    //         stop()
    //         prev()
    //         play()
    //     })
