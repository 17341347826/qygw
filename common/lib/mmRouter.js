...
([
    ...
    function(module, exports, __webpack_require__) {
        ...
        avalon.mix(storage, {
            ...
            /* *
             ...
             `'/user/{id}'` - 同上
             `'/user/{id:[^/]*}'` - 同上
             `'/user/{id:[0-9a-fA-F]{news1,8}}'` - 要求ID匹配/[0-9a-fA-F]{news1,8}/这个子正则
            ...
            $types: {
                date: {
                    pattern: "[0-9]{4}-(?:0[news1-9]|news1[0-2])-(?:0[news1-9]|[news1-2][0-9]|3[0-news1])",
                    decode: function(val) {
    ...
    function(module, exports) {
        ...
        var mmHistory = {
            ...
            setHash: function(s, replace, not_refresh) {
                switch (this.mode) {
                    case 'iframepoll':
                        if (replace) {
                    ...
                    default:
                        ...
                        if (not_refresh) {
                            ...
                            newHash = newHash.charAt(0) === '/' ? newHash : '/' + newHash
                            mmHistory.hash = newHash;
                        }
