...
define([
        C.CLF('avalon.js'),
        C.Co("about", "recruit/recruit", "css!"),
        C.Co("about", "recruit/recruit", "html!"),
        "layer",
        C.CM('advice'),
        C.CM('page_title'),
        C.CM('notice'),
    ...
    function (avalon, css,html, layer, advice,page_title,notice,amazeui) {
        ...
        var avalon_define = function () {
            ...
            vm.$watch('onReady', function () {
                ajax_post(query_module, {module_info: {id: '0000000156559604088729E4E6454C38'}}, this, this.is_check);
                //banner轮播
