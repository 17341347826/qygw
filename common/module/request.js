                ...
                success: function (repsData, statusCode, xhr) {
                    if (xhr.status == 401) {
                        ...
                        if (repsData.status != 200) { /*失败*/
                            ...
                            //     }
                            // }
                            who.on_request_complete(cmd, repsData.status, repsData, false, repsData.message, is_check)
                        } else { /*成功*/
                            who.on_request_complete(cmd, repsData.status, repsData, true, repsData.message, is_check);
                        }
                    }
